...
function RentalMachineryListingCard({ listing }) {
  return (
    <article className="marketplace-listing-card">
      ...
      <div className="marketplace-price-box">
        ...
        <Link className="marketplace-price-link" to={`/rental-machinery-details/${listing._id}`}>
          {listing.buttonLabel}
        </Link>
      </div>
    </article>
...
export default RentalMachineryListingCard;
