...
function SparePartsCatalogFilters({
  categories = [],
  cities = [],
  filters = {},
  onChange = () => {},
  ...
  return (
    <div className="marketplace-sidebar-shell position-relative">
      <div className="marketplace-sidebar-mobile-toggle d-xl-none">
        <button
          aria-controls="sparePartsCatalogFiltersBody"
      ...
      <aside className="marketplace-sidebar">
        <div
          ...
          id="sparePartsCatalogFiltersBody"
        ...
        >
          <div className="marketplace-sidebar-inner" ref={collapseRef}>
            ...
            <div className="market-filter-group compact">
              <div className="market-filter-title"><span /> MANUFACTURING YEAR <i className="fa fa-angle-down" /></div>
...
export default SparePartsCatalogFilters;
