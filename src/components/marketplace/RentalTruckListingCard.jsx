...
function RentalTruckListingCard({ listing }) {
  return (
    <article className="marketplace-listing-card">
      ...
      <div className="marketplace-listing-copy">
        ...
        <strong>Availability: {listing.quantity}</strong>
      ...
      <div className="marketplace-price-box">
        <small>Per Hour Rental</small>
        <strong>{listing.price}</strong>
        <Link className="marketplace-price-link" to={`/rental-truck-details/${listing._id}`}>
          {listing.buttonLabel}
        </Link>
      </div>
    </article>
...
export default RentalTruckListingCard;
