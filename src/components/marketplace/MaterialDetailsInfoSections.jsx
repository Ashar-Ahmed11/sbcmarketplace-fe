  ...
  const sections = [
    {
      ...
      rows: [
        ...
        ['Quantity', valueOrDash(material?.quantity), 'City', valueOrDash(material?.city)],
        ['Location', valueOrDash(material?.location), 'Approval Status', valueOrDash(material?.approvalStatus)],
        ['Price', valueOrDash(material?.price ? `Rs. ${Number(material.price).toLocaleString()}` : '')],
