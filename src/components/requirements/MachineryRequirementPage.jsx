...
const machineryRequirementInitialForm = {
  category: '',
  brand: '',
  condition: 'both',
  budget: '',
...
function MachineryRequirementPage() {
  ...
  const [form, setForm] = useState(machineryRequirementInitialForm);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await createMachineryRequirement(form);
      history.push('/post-a-requirement/construction-machinery/success', {
    ...
    <main className="requirement-page">
      <div className="container-xl requirement-shell">
        <div className="requirement-content">
          <div className="requirement-breadcrumb">SBC / Post a Requirement / <strong>Construction Machinery</strong></div>
          ...
          <section className="mb-4">
            ...
            <p className="requirement-hero__text mb-0">
              The more detail you give, the better SBC can match you to the right machinery sellers.
            </p>
          </section>
          ...
          <div className="requirement-tabs">
            ...
            <button className="requirement-tab active" type="button">Construction Machinery</button>
          ...
          <section className="requirement-form-card">
            <div className="requirement-form-section">
              <h2 className="requirement-form-section__title">Machinery Details</h2>
              <div className="row g-3">
                <div className="col-md-6 col-12 requirement-field">
                  <label>Construction Machinery Category</label>
                  <select onChange={(event) => setForm((current) => ({ ...current, category: event.target.value }))} value={form.category}>
                    <option value="">Select category</option>
                    {machineryCategories.map((item) => <option key={item._id} value={item._id}>{item.name}</option>)}
                  </select>
                </div>
                <div className="col-md-6 col-12 requirement-field">
                  <label>Brand</label>
            ...
            <div className="requirement-form-section">
              ...
              <div className="requirement-match-note">
                <strong>How matching works:</strong> once submitted, SBC matches your machinery requirement with approved construction machinery listings by budget, category, brand, condition and delivery preference, then notifies the matching sellers.
              </div>
            </div>
        ...
        <ConfirmModal
          body="Are you sure you want to submit this construction machinery requirement? SBC will notify matching machinery sellers and initiate negotiations on your behalf."
...
export default MachineryRequirementPage;
