...
function MachineryRequirementSuccessPage() {
      ...
      <div className="container-xl requirement-shell">
        <section className="requirement-success">
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="requirement-success__seller-meta">
                      {seller.city || 'Matched Seller'}{seller.machineryTitle ? ` • ${seller.machineryTitle}` : ''}
                    </div>
                  </div>
                </div>
          ...
          <div className="requirement-success__actions">
            ...
            <button className="dashboard-secondary-btn" onClick={() => history.push('/user-dashboard/my-negotiations/construction-machinery')} type="button">
              View Negotiations
            </button>
          </div>
        </section>
...
export default MachineryRequirementSuccessPage;
