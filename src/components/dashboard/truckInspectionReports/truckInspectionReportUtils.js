export const truckInspectionReportSections = [
...
export const createEmptyTruckInspectionReportForm = () => ({
  inspectionRequester: '',
...
export const getTruckInspectionOverallScore = (report) => {
  const values = truckInspectionReportSections.map(({ key }) => Number(report?.[key]?.score) || 0);
