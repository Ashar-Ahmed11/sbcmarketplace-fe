...
function AdminFinanceInstallmentModulePlaceholderPage() {
  ...
  return (
    <section className="dashboard-section-card form-card-panel">
      ...
      <div className="truck-empty-state">
        ...
        <p>Truck installments are currently the live finance installment module in the admin dashboard.</p>
...
export default AdminFinanceInstallmentModulePlaceholderPage;
