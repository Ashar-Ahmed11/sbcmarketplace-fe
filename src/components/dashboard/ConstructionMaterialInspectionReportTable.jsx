...
import { getConstructionMaterialInspectionOverallScore } from './constructionMaterialInspectionReports/constructionMaterialInspectionReportUtils';

function ConstructionMaterialInspectionReportTable({ actionLabel, actionTo, rows, subtitle, title, viewBasePath }) {
  return (
        ...
        <table className="table dashboard-table">
          ...
          <tbody>
            {rows.length ? rows.map((item) => (
              <tr key={item._id}>
                <td className="py-3">{item.constructionMaterialInspectionNegotiation?.constructionMaterial?.title || 'Construction Material Inspection Report'}</td>
                ...
                <td className="py-3">{getConstructionMaterialInspectionOverallScore(item)}%</td>
            ...
            )) : <tr><td className="text-center py-4" colSpan="7">No construction material inspection reports found.</td></tr>}
          </tbody>
        </table>
      </div>
    </section>
...
export default ConstructionMaterialInspectionReportTable;
