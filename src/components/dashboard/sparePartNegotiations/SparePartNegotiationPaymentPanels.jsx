import { getSparePartNegotiationTotals } from './sparePartNegotiationUtils';
...
function SparePartNegotiationPaymentPanels({ acceptedOffer, basicInfo, isBuyer, onOpenAdvanceProof, onOpenFinalProof, row }) {
  if (!acceptedOffer) return null;

  const totals = getSparePartNegotiationTotals(acceptedOffer, basicInfo);
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Spare Part Cost" value={formatCurrency(totals.sparePartCost)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Spare Part Cost" value={formatCurrency(totals.sparePartCost)} />
...
export default SparePartNegotiationPaymentPanels;
