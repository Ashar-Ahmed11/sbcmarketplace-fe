import { getAcceptedSparePartOffer } from './sparePartNegotiationUtils';

function formatCurrency(value) {
  return `Rs. ${Number(value || 0).toLocaleString()}`;
}

function SparePartNegotiationConversation({
  currentUserId,
  onAccept,
  onOpenCounterOffer,
  row,
          ...
          return (
            <div className={`truck-negotiation-bubble ${isViewer ? 'buyer' : 'seller'}`} key={item._id}>
              <div className="truck-negotiation-bubble__inner">
                ...
                <strong>
                  {formatCurrency(item.sparePartCost)}
...
export default SparePartNegotiationConversation;
