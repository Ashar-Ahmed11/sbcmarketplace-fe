...
function ConstructionMaterialInspectionPurchaseOrder({ basicInfo, reportBasePath, row }) {
  ...
  return (
    <>
      {row.constructionMaterialInspectionReport?._id ? (
        <div className="dashboard-form-actions mb-3">
          <Link className="dashboard-action-btn" to={`${reportBasePath}/${row.constructionMaterialInspectionReport._id}`}>View Inspection Report</Link>
        </div>
      ) : null}
          ...
          <table className="table truck-purchase-order__table">
            <thead>
              <tr>
                <th>Title</th>
                <th>Category</th>
                <th>Construction Material Inspection Service Cost</th>
                <th>Total</th>
              </tr>
            </thead>
            <tbody>
...
export default ConstructionMaterialInspectionPurchaseOrder;
