import { getTruckInspectionReportStatus, getTruckInspectionServiceNegotiationTotals } from './truckInspectionNegotiationUtils';
...
function TruckInspectionNegotiationPaymentPanels({
  acceptedOffer,
  basicInfo,
  isBuyer,
  onOpenAdvanceProof,
  ...
  const totals = getTruckInspectionServiceNegotiationTotals(acceptedOffer, basicInfo);
  const reportStatus = getTruckInspectionReportStatus(row);
  const isReportApproved = row?.truckInspectionReport?.status === 'approved';
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Truck Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Truck Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
...
export default TruckInspectionNegotiationPaymentPanels;
