import { getMachineryNegotiationTotals } from './machineryNegotiationUtils';
...
function MachineryNegotiationPaymentPanels({ acceptedOffer, basicInfo, isBuyer, onOpenAdvanceProof, onOpenFinalProof, row }) {
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Machinery Cost" value={formatCurrency(totals.machineryCost)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Machinery Cost" value={formatCurrency(totals.machineryCost)} />
...
export default MachineryNegotiationPaymentPanels;
