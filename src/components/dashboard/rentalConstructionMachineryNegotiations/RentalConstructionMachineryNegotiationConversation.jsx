import { getAcceptedRentalConstructionMachineryOffer } from './rentalConstructionMachineryNegotiationUtils';
...
function RentalConstructionMachineryNegotiationConversation({
  currentUserId,
  onAccept,
  onOpenCounterOffer,
  row,
...
export default RentalConstructionMachineryNegotiationConversation;
