...
import {
  getAcceptedRentalConstructionMachineryOffer,
  getRentalConstructionMachineryNegotiationTotals,
} from './rentalConstructionMachineryNegotiationUtils';
...
function RentalConstructionMachineryPurchaseOrder({ basicInfo, row }) {
    ...
    <section className="dashboard-section-card truck-purchase-order">
      ...
      <div className="truck-purchase-order__table-wrap">
        <table className="table truck-purchase-order__table">
          ...
          <tbody>
            <tr>
              <td>{row.machinery?.title || '—'}</td>
              <td>{row.machinery?.category?.name || '—'}</td>
              <td>{row.machinery?.brand || '—'}</td>
...
export default RentalConstructionMachineryPurchaseOrder;
