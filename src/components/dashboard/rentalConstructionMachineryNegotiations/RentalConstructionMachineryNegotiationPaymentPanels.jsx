import { getRentalConstructionMachineryNegotiationTotals } from './rentalConstructionMachineryNegotiationUtils';
...
function RentalConstructionMachineryNegotiationPaymentPanels({
  acceptedOffer,
  basicInfo,
  isBuyer,
  onOpenAdvanceProof,
  ...
  const totals = getRentalConstructionMachineryNegotiationTotals(acceptedOffer, basicInfo);
      ...
      <section className="dashboard-section-card truck-negotiation-payment">
        <div className="truck-negotiation-payment__head">
          <div>
            ...
            <p>Pay advance fee to move this rental deal forward.</p>
          </div>
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Security Deposit Amount" value={formatCurrency(totals.securityDepositAmount)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Security Deposit Cost" value={formatCurrency(totals.securityDepositAmount)} />
          {row.sellerDelivery ? <PaymentRow label="Agreed Delivery Cost" value={formatCurrency(totals.deliveryCost)} /> : null}
          <PaymentRow label="Agreed Mobilization Cost" value={formatCurrency(totals.mobilizationCost)} />
          <PaymentRow label="Agreed Demobilization Cost" value={formatCurrency(totals.demobilizationCost)} />
          <PaymentRow label="Agreed Total Cost" value={formatCurrency(totals.finalBaseTotal)} />
...
export default RentalConstructionMachineryNegotiationPaymentPanels;
