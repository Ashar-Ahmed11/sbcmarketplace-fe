import { getMachineryInspectionNegotiationTotals, getMachineryInspectionReportStatus } from './machineryInspectionNegotiationUtils';
...
function MachineryInspectionNegotiationPaymentPanels({
  acceptedOffer,
  basicInfo,
  isBuyer,
  onOpenAdvanceProof,
  ...
  const totals = getMachineryInspectionNegotiationTotals(acceptedOffer, basicInfo);
  const reportStatus = getMachineryInspectionReportStatus(row);
  const isReportApproved = row?.machineryInspectionReport?.status === 'approved';
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Machinery Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Machinery Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
...
export default MachineryInspectionNegotiationPaymentPanels;
