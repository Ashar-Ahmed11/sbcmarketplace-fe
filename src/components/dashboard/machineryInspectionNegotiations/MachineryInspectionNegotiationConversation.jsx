import { formatInspectionSchedule, getAcceptedMachineryInspectionOffer } from './machineryInspectionNegotiationUtils';

function formatCurrency(value) {
  return `Rs. ${Number(value || 0).toLocaleString()}`;
}

function MachineryInspectionNegotiationConversation({
  currentUserId,
  onAccept,
  onOpenCounterOffer,
  row,
  ...
  title = 'Machinery Inspection Negotiation',
}) {
...
export default MachineryInspectionNegotiationConversation;
