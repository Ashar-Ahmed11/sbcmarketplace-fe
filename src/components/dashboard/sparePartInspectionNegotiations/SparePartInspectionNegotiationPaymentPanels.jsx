import { getSparePartInspectionReportStatus, getSparePartInspectionNegotiationTotals } from './sparePartInspectionNegotiationUtils';
...
function SparePartInspectionNegotiationPaymentPanels({
  acceptedOffer,
  basicInfo,
  isBuyer,
  onOpenAdvanceProof,
  ...
  const reportStatus = getSparePartInspectionReportStatus(row);
  const isReportApproved = row?.sparePartInspectionReport?.status === 'approved';
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Spare Part Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Spare Part Inspection Service Cost" value={formatCurrency(totals.labourCharges)} />
...
export default SparePartInspectionNegotiationPaymentPanels;
