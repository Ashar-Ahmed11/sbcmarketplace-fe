import { getRepairServiceNegotiationTotals } from './repairServiceNegotiationUtils';
...
function RepairServiceNegotiationPaymentPanels({ acceptedOffer, basicInfo, isBuyer, onOpenAdvanceProof, onOpenFinalProof, row }) {
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Repair Service Cost" value={formatCurrency(totals.labourCharges)} />
    ...
    return (
      <section className="dashboard-section-card truck-negotiation-payment">
        ...
        <div className="truck-negotiation-payment__card">
          ...
          <PaymentRow label="Agreed Repair Service Cost" value={formatCurrency(totals.labourCharges)} />
          {row.onSite ? <PaymentRow label="Agreed Delivery Cost" value={formatCurrency(totals.deliveryCost)} /> : null}
...
export default RepairServiceNegotiationPaymentPanels;
